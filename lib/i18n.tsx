...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    "nav.credits": "积分",
    "paypal.total": "总计",
    "paypal.loading": "正在加载 PayPal...",
    "paypal.status.success": "支付成功。",
    "paypal.status.cancel": "支付已取消。",
    "paypal.error.missingClientId": "缺少 NEXT_PUBLIC_PAYPAL_CLIENT_ID，请在 .env.local 中设置。",
    "paypal.error.timeout": "加载 PayPal 超时，请重试。",
    "paypal.error.missingSku": "缺少商品 SKU。",
    "paypal.error.createOrderFailed": "创建 PayPal 订单失败。",
    "paypal.error.missingOrderId": "缺少 orderID。",
    "paypal.error.captureFailed": "支付确认失败。",
    "paypal.error.generic": "PayPal 支付出现异常。",
  ...
  en: {
    ...
    "paypal.status.success": "Payment successful.",
    "paypal.status.cancel": "Payment canceled.",
    "paypal.error.missingClientId": "Missing NEXT_PUBLIC_PAYPAL_CLIENT_ID. Please set it in .env.local.",
    "paypal.error.timeout": "Timed out loading PayPal. Please try again.",
    "paypal.error.missingSku": "Missing product sku.",
    "paypal.error.createOrderFailed": "Failed to create PayPal order.",
    "paypal.error.missingOrderId": "Missing orderID.",
    "paypal.error.captureFailed": "Capture failed.",
    "paypal.error.generic": "PayPal error.",
